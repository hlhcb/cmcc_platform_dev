...
import com.cmcc.system.mapper.SysPostMapper;
import com.cmcc.system.mapper.SysRoleMapper;
import com.cmcc.system.mapper.SysUserPostMapper;
...
import com.cmcc.common.utils.bean.BeanValidators;
import com.cmcc.common.utils.spring.SpringUtils;
import com.cmcc.system.domain.SysPost;
import com.cmcc.system.domain.SysUserPost;
import com.cmcc.system.domain.SysUserRole;
import com.cmcc.system.mapper.SysUserMapper;
import com.cmcc.system.mapper.SysUserRoleMapper;
        ...
        for (SysUser user : userList)
        {
            try
            {
                ...
                if (StringUtils.isNull(u))
                {
                    ...
                    // 获取当前密码
                    String currentPassword = password+user.getPhonenumber().substring(user.getPhonenumber().length()-4);
                    user.setPassword(SecurityUtils.encryptPassword(currentPassword));
