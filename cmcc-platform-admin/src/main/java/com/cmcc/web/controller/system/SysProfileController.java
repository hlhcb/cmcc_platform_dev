...
import com.cmcc.common.utils.file.MimeTypeUtils;
import com.cmcc.framework.web.service.TokenService;
...
public class SysProfileController extends BaseController
{
    ...
    public AjaxResult avatar(@RequestParam("avatarfile") MultipartFile file) throws Exception
    {
        ...
        {
            LoginUser loginUser = getLoginUser();
            String avatar = FileUploadUtils.upload(CmccConfig.getAvatarPath(), file, MimeTypeUtils.IMAGE_EXTENSION);
