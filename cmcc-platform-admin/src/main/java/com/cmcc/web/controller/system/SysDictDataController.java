...
public class SysDictDataController extends BaseController
{
    ...
    private AppDictData getAppObj(SysDictData sysDictData)
    {
        ...
        appDictData.setText(sysDictData.getDictLabel());
        appDictData.setValue(sysDictData.getDictValue());
        return appDictData;
    }
...
//    @PreAuthorize("@ss.hasPermi('system:dict:query')")
    ...
    public AjaxResult getDict(@PathVariable String dictType)
    {
        ...
        for (SysDictData a: data)
        {
            AppDictData appObj = getAppObj(a);
            list.add(appObj);
